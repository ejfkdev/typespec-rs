...
/// Macro to define visitor methods. Generates a list of method signatures
/// for both `Visitor` (no context) and `VisitorWithContext` (with &mut C).
/// Usage: `visitor_methods!(ctx)` for with-context, `visitor_methods!()` for without.
macro_rules! visitor_methods {
    ...
    (ctx) => {
        ...
        fn visit_string_template_expression(
            &mut self,
            _ctx: &mut C,
            _node: &StringTemplateExpression,
        ) {
        }
        ...
        fn visit_object_literal_spread_property(
            &mut self,
            _ctx: &mut C,
            _node: &ObjectLiteralSpreadProperty,
        ) {
        }
        ...
        fn visit_operation_signature_declaration(
            &mut self,
            _ctx: &mut C,
            _node: &OperationSignatureDeclaration,
        ) {
        }
        fn visit_operation_signature_reference(
            &mut self,
            _ctx: &mut C,
            _node: &OperationSignatureReference,
        ) {
        }
        ...
        fn visit_augment_decorator_statement(
            &mut self,
            _ctx: &mut C,
            _node: &AugmentDecoratorStatement,
        ) {
        }
        ...
        fn visit_template_parameter_declaration(
            &mut self,
            _ctx: &mut C,
            _node: &TemplateParameterDeclaration,
        ) {
        }
